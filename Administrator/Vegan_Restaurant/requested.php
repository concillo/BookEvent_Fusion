...
<body>
    ...
    <?php
        ...
        // SQL query to retrieve data from users and user_requests tables for the vegetarian store
        ...
        if ($result->num_rows > 0) {
            ...
            echo "No user requests from the vegetarian store found";
        }
