...
<body>
    ...
    <?php
        ...
        // SQL query to retrieve data from users and user_requests tables for the Mediterranean store
        ...
        if ($result->num_rows > 0) {
            ...
            echo "No user requests from the Mediterranean store found";
        }
