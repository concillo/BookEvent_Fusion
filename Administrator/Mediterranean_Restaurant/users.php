...
<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <button class="btn btn-primary float-right btn-action" id="new_user">New User</button>
        </div>
    </div>
    <br>
    <div class="row">
        <div class="card col-lg-12">
            <div class="card-body">
                <table id="user_table" class="table table-striped table-bordered">
                    ...
                    // Fetch users whose store choice matches the American restaurant
                    $users = $conn->query("SELECT id, username, email, type, store FROM users WHERE store = 'mediterranean' ORDER BY username ASC");
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-action dropdown-toggle dropdown-toggle-split"
