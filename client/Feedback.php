...
<head>
    ...
    <title>Booking Venue Management</title>
...
<body>
    ...
    <div class="container event-container">
        ...
        $sql = "SELECT u.*, AVG(r.rating) AS avg_rating
        FROM user_requests u
        LEFT JOIN reviews r ON u.id = r.requests_id
        GROUP BY r.id
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<p><strong>Average Rating:</strong> " . generateStarRating(round($row['avg_rating'], 1)) . "</p>"; // Display average rating as stars
                ...
                echo "<a href='planning.php?id=" . $row['id'] . "' class='btn btn-primary'>Plan Now</a>";

                // Display comments from reviews table
                echo "<div class='reviews'>";
                echo "<h4>Reviews:</h4>";
                $reviewSql = "SELECT * FROM reviews WHERE requests_id = " . $row['id'];
                $reviewResult = $conn->query($reviewSql);
                if ($reviewResult->num_rows > 0) {
                    while ($reviewRow = $reviewResult->fetch_assoc()) {
                        echo "<p><strong>Rating:</strong> " . generateStarRating($reviewRow['rating']) . "</p>"; // Display individual ratings as stars
